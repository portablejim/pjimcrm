...
class TimesheetModelTests(TestCase):
    def test_auto_calculate_length(self):
        ...
        # Start a timer.
        testTimesheetEntry = TimesheetEntry(project=testProject, timestamp_started=time1, description='Test', description_set=False, is_invoiced=False)
        ...
        self.assertEqual(datetime.timedelta(), testTimesheetEntry.length_raw, "When initially running, raw length should be empty.")
        self.assertEqual(datetime.timedelta(), testTimesheetEntry.length_rounded, "When initially running, rounded length should be empty.")
        ...
        self.assertEqual(datetime.timedelta(minutes=15), testTimesheetEntry.length_rounded, "On stopping, the rounded length should be set.")
        ...
        self.assertIsNone(testTimesheetEntry.timestamp_started, "On stopping, the started time should be cleared")
        self.assertIsNone(testTimesheetEntry.timestamp_stopped, "On stopping, the stopped time should be cleared")
        self.assertEqual(datetime.timedelta(minutes=30), testTimesheetEntry.length_raw, "On stopping again, the raw length should be added.")
        self.assertEqual(datetime.timedelta(minutes=30), testTimesheetEntry.length_rounded, "On stopping again, the rounded length should be added.")
        self.assertEqual(time1, testTimesheetEntry.timestamp_started_old, "On stopping, the start time should be in the old fields.")
        self.assertEqual(time2, testTimesheetEntry.timestamp_stopped_old, "On stopping, the start time should be in the old fields.")
        ...
        self.assertIsNone(testTimesheetEntry.timestamp_started, "On stopping, the started time should be cleared")
        self.assertIsNone(testTimesheetEntry.timestamp_stopped, "On stopping, the stopped time should be cleared")
        self.assertEqual(datetime.timedelta(minutes=31), testTimesheetEntry.length_raw, "On stopping again, the raw length should be added.")
        self.assertEqual(datetime.timedelta(minutes=45), testTimesheetEntry.length_rounded, "On stopping again, the rounded length should be added.")
        self.assertEqual(time1, testTimesheetEntry.timestamp_started_old, "On stopping, the start time should be in the old fields.")
        self.assertEqual(time2, testTimesheetEntry.timestamp_stopped_old, "On stopping, the start time should be in the old fields.")
