    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_uuid', models.UUIDField(default=uuid.UUID('e327b6fe-6ade-4266-ae34-8126b1b31855'), verbose_name='UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('length_rounded', models.DurationField(default=datetime.timedelta(0), verbose_name='Length (rounded)')),
                ...
                ('timestamp_started_old', models.DateTimeField(blank=True, null=True, verbose_name='Previously Started')),
                ('timestamp_stopped_old', models.DateTimeField(blank=True, null=True, verbose_name='Previously Stopped')),
