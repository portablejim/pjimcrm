...
urlpatterns = [
    ...
    path(
        "client/<int:client_id>/project/<int:project_id>/timer-start",
        views.project_timer_start,
        name="project_timer_start",
    ),
    path(
        "client/<int:client_id>/project/<int:project_id>/timer/<int:timer_id>",
        views.project_timer_detail,
    ...
    path("timer/<int:timer_id>/restart", views.timer_restart, name="timer_restart"),
    ...
    path("timer/actions/delete", views.timer_current_delete, name="timer_delete"),
]
